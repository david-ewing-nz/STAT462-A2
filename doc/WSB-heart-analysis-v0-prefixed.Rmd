...
```{r child1-file-info, echo=FALSE, results='asis'}
...
<!-- Inserted from WBS: heart-step-02 -->
```{r heart-step-heart-02}
...
<!-- Inserted from WBS: heart-step-03 -->
```{r  heart-step.heart-03}
...
<!-- Inserted from WBS: heart-step-04 -->
```{r  heart-step.heart-04}
...
<!-- Inserted from WBS: heart-step-07 -->
```{r  heart-step-07}
...
<!-- Inserted from WBS: heart-step-09 -->
```{r  heart-step-09}
...
<!-- Inserted from WBS: heart-step-10 -->
```{r  heart-step-10}
...
<!-- Inserted from WBS: heart-step-11 -->
### QDA Evaluation
<!-- Inserted from WBS: heart-step-11.1 -->
```{r heart-step-11.1}
cat("### QDA Evaluation\n")
...
<!-- Inserted from WBS: heart-step-12 -->
```{r heart-step-12}
